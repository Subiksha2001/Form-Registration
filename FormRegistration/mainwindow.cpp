...
{
    QMessageBox::StandardButton reply=QMessageBox::question(this,"subie 4161","Do you want to submit the form?",QMessageBox::Ok|QMessageBox::Cancel);
    if(reply==QMessageBox::Ok)
    {
        QMessageBox::information(this,"subie 4161","Submitted successfully!");
    }
